  ...
  timeline
    .sequence([
      ...
      timeline.animate({
        ...
        offset: helpers.startBefore(600)
      })
    ])
    .start()
}
...
export class Timing extends React.Component {
  componentDidMount() {
    animate({ one: '#one', two: '#two', three: '#three' })
  }
